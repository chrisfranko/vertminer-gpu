...
static void set_threads_hashes(unsigned int vectors,int64_t *hashes, size_t *globalThreads,
			       unsigned int minthreads, __maybe_unused int *intensity, __maybe_unused int *rawintensity)
{
				...
				int64_t __maybe_unused max_nonce)
{
	...
	set_threads_hashes(clState->vwidth, &hashes, globalThreads, localThreads[0], &gpu->intensity, &gpu->rawintensity);
